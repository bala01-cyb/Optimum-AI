    ...
    <nav className="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 sticky top-0 z-[100]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <img src="/optimum.png" alt="OPTIMUM" className="h-8 w-8" />
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button
              onClick={toggleTheme}
              className="p-2 text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition-colors rounded-lg"
            ...
            <div>
              {userProfilePicture ? (
                <img
                  ...
                  alt={userData?.name}
                  className="h-9 w-9 rounded-full object-cover cursor-pointer ring-2 ring-blue-500 hover:ring-blue-600 transition-all"
                  onClick={handleProfileClick}
                />
              ) : (
                <div
                  className="h-9 w-9 bg-blue-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-blue-600 transition-colors"
                  onClick={handleProfileClick}
                >
          ...
          <div className="md:hidden flex items-center space-x-3 z-[101]">
            {/* Profile Picture - Always visible on mobile */}
            {userProfilePicture ? (
              <img
                src={userProfilePicture}
                alt={userData?.name}
